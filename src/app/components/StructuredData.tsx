    ...
    offers: [
      {
        ...
        price: "0",
        priceCurrency: "EUR",
        description: "30 crediti / mese (≈30k token) ≈ ~6 analisi — 1 credito = 1.000 token",
      },
      {
        "@type": "Offer",
        name: "Starter",
        price: "4.99",
        priceCurrency: "EUR",
        description: "1.500 crediti / mese ≈ ~300 analisi",
      },
      {
        "@type": "Offer",
        name: "Pro",
        price: "7.99",
        priceCurrency: "EUR",
        description: "3.000 crediti / mese ≈ ~600 analisi",
      },
      {
        "@type": "Offer",
        name: "Team",
